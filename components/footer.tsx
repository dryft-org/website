...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-foreground/95 via-foreground/90 to-foreground/85 text-white" style={{ background: 'linear-gradient(to bottom, oklch(0.25 0.15 142.5), oklch(0.20 0.12 142.5))' }}>
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-2 space-y-5">
            ...
            <div className="flex gap-3 pt-2">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-primary hover:bg-accent transition-all duration-300 flex items-center justify-center"
                aria-label="Facebook"
              >
        ...
        <div className="border-t border-gray-600 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-300">
            <div className="text-center md:text-left">
              <p>&copy; {currentYear} Dryft Rwanda Ltd. All rights reserved.</p>
